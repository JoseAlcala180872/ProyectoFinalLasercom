...
public class ActividadBO {
     ...
     * @throws BOException Si la actividad es invalida o hay un error en la capa DAO.
     */
    ...
    /**
     * Cambia el estado de una actividad (Pendiente -> En progreso -> Terminado). 
     * @param idActividad ID de la actividad.
     * @param nuevoEstado Nuevo estado a asignar.
     * @throws BOException Si la actividad no existe o hay un error en la capa DAO.
     */
    ...
    /**
     * Actualiza los datos editables de una actividad (titulo, descripcion, fecha).
     * @param actividad Actividad con datos actualizados.
     * @throws BOException Si la actividad esta terminada o hay un error en la capa DAO.
     */
     ...
     * @throws BOException Si el monto es invalido o la actividad no esta terminada.
     */
